...
<body>
        ...
        <div class="d-flex flex-column">
            ...
            <nav id="navbar" class="nav-menu navbar">
                <ul>
                    ...
                    <li>
                        <a href="#about" class="nav-link scrollto active"><i
    ...
    <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
        <div class="hero-container" data-aos="fade-in">
            <h1>Yusuf Amin Abdillah</h1>
            <p>I'm <span class="typed" data-typed-items="Designer, Developer, IoT Engineer, Freelancer"></span></p>
        </div>
    </section>
    <!-- End Hero -->
                ...
                <div class="row">
                    <div class="col-lg-6" data-aos="fade-up">
                        ...
                        <div class="resume-item pb-0">
                            ...
                            <ul>
                                <li>North Jakarta, DKI Jakarta, Indonesia</li>
                                <li>+62 853 1100 0921</li>
                                <li>yusufaa@gmail.com</li>
                            </ul>
                        </div>
                        ...
                        <div class="resume-item">
                            ...
                            <h5>2021 - 2025</h5>
                            <p><em>Asia e University, Malaysia</em></p>
                        ...
                        <div class="resume-item">
                            <h4>Professional Certification of Information & Technology</h4>
                            <h5>2021 - 2023</h5>
                            <p><em>University of Indonesia, Indonesia</em></p>
                    ...
                    <div class="col-lg-5 d-flex align-items-stretch">
                        <div class="info">
                            <div class="address">
                                ...
                                <h4>Location</h4>
                                <p>Jl. Perintis kemerdekaan, Warung Jengkol, rt 004 / rw 013 No. 22, Pegangsaan Dua,
                                    Kelapa Gading, Jakarta Utara, 14250, DKI Jakarta.</p>
                            </div>

                            <div class="email">
                                <i class="bi bi-envelope"></i>
                                <h4>Email</h4>
                                <p>yusufaa464@gmail.com</p>
                            </div>

                            <div class="phone">
                                <i class="bi bi-phone"></i>
                                <h4>Call</h4>
                                <p>+62 853 1100 0921</p>
                            </div>

                            <iframe
                                src="https://maps.google.com/maps?q=kelapa%20gading&amp;t=&amp;z=13&amp;ie=UTF8&amp;iwloc=&amp;output=embed"
